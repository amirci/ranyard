...
describe SessionsController do
  describe "routing" do
    ...
    it "routes planning to attend" do
      post("/sessions/1/attending").should route_to("sessions#attending", :id=> "1")
    end

    it "routes not planning to attend" do
      post("/sessions/1/not_attending").should route_to("sessions#not_attending", :id=> "1")
    end
